                ...
                <div class="row ">
                    <div class="col-md-8  " style="margin: auto; max-width: 750px;">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li><router-link to="/dashboard/budget/compensations" tag="span" style="cursor: pointer" custom v-slot="{ navigate }"><span @click="navigate" @keypress.enter="navigate" role="link"><a data-toggle="tab" class="nav-item nav-link active" style="text-decoration: none;">Compensations Spendings</a></span></router-link></li>
                        ...
                        <div class="card h-100 shadow">
                            <div class="card-body">
                                <canvas id="myChartComp" style="padding: 20px;"></canvas>
                            </div>
                        </div> 
                    </div>
                    <div class="col-md-4" >
        ...
        methods: {
            ...
            handleGraphs () {
                ...
                /*if(this.graphAll) {
                    ...
                    this.graphAll.budgetValues.forEach((val) => {
                        newLabelsAllBudget.push(val.budget)
                    })
                ...
                if(this.graphTOS[1].budgetValues){
                    ...
                    let newLabelsTypeBudget = []
                    this.graphTOS[1].budgetValues.forEach((val) => {
                        newLabelsTypeBudget.push(val.value)
                    })
                ...
                getServicesByType(this.graphTOS[1].typeOfService._id, this.token).then(res => {
