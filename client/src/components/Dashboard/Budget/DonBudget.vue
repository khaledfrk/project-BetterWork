                ...
                <div class="row ">
                    <div class="col-md-8  " style="margin: auto; max-width: 750px;">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li><router-link to="/dashboard/budget/donations" tag="span" style="cursor: pointer" custom v-slot="{ navigate }"><span @click="navigate" @keypress.enter="navigate" role="link"><a data-toggle="tab" class="nav-item nav-link active" style="text-decoration: none;">Donations Spendings</a></span></router-link></li>
                        ...
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-body">
                                <canvas id="myChartDon" style="padding: 20px;"></canvas>
                            </div>
        ...
        methods: {
            ...
            handleGraphs () {
                ...
                if(this.graphTOS[0].budgetValues){
                    ...
                    this.graphTOS[0].budgetValues.forEach((val) => {
                        newLabelsTypeBudget1.push(val.value)
                    })
                    var myChartType = new Chart(ctx3, {
                        type: 'line',
                        data: {
                ...
                getServicesByType(this.graphTOS[0].typeOfService._id, this.token).then(res => {
