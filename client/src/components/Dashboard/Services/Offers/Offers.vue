  ...
  <div class="p-4">
    <div class="container m-0">       
        <ul class="nav nav-tabs">
          ...
          <li><a data-toggle="tab" class="nav-item nav-link linka"  style="text-decoration: none;"><router-link to="/dashboard/services/donations" tag="span" style="cursor: pointer" custom v-slot="{ navigate }"><span @click="navigate" @keypress.enter="navigate" role="link">Donations</span></router-link></a></li>
          ...
          <li><a data-toggle="tab" class="nav-item nav-link active"  style="text-decoration: none;"><router-link to="/dashboard/services/offers" tag="span" style="cursor: pointer" custom v-slot="{ navigate }"><span @click="navigate" @keypress.enter="navigate" role="link">Offers</span></router-link></a></li>
        </ul>
            ...
            <div v-if="services.length > 0">
              <div class="row  shadow m-1 mb-4" v-for="serv in services" :key="serv._id">
                ...
                <div class="col-8 p-4 pr-0 pl-3">
                   <h4 class="ml-3">{{serv.name}} {{typeOfService.name}}</h4>
                </div>
                <div class="col-3">
                 <div class="row justify-content-end">
                   <div class="col-3 mt-4 p-0"><a class="edit" title="Edit" data-toggle="tooltip" ><i @click="goToUpdateService(serv)" class="material-icons linka" style="text-decoration: none; cursor: pointer;">&#xE254;</i></a></div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content p-4">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary p-1 pl-3 pr-3 btn-grad" data-dismiss="modal" style="padding:15px 45px;font-size:15px">keep</button>
                <button @click="handleDeleteService(service._id)" type="button" class="btn btn-primary btn-grad2 p-1 pl-3 pr-3"  data-dismiss="modal" style="padding:15px 45px;font-size:15px">Delete</button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods:{
    ...
    handleGetServicesByName(name) {
      ...
      this.$router.go(this.$router.push('/dashboard/services/offers/search/' + name))
    },
    ...
    goToAddService() {
      this.$router.push('/dashboard/services/offers/add')
    },
    ...
    goToUpdateService(service) {
      this.handleGetServiceById(service._id)
      this.$router.push('/dashboard/services/offers/update')
    },
  }
}
</script>
