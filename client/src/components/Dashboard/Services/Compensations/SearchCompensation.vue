  ...
  <div>
    <div class="container m-0" v-if="types">       
        <ul class="nav nav-tabs">
          ...
          <li><a data-toggle="tab" class="nav-item nav-link active"  style="text-decoration: none;"><router-link to="/dashboard/services/compensations" tag="span" style="cursor: pointer" custom v-slot="{ navigate }"><span @click="navigate" @keypress.enter="navigate" role="link">Compensations</span></router-link></a></li>
          ...
          <div class="tab-pane show in active">
            ...
            <div v-if="services.length > 0">
              <div class="row  shadow m-1 mb-4" v-for="serv in services" :key="serv._id">
                <div class="pr-5" style="display: block; background-color: #e97923; width: 2px;"></div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button @click="handleDeleteService(service._id)" type="button" class="btn btn-primary btn-grad2 p-1 pl-3 pr-3"  data-dismiss="modal">Delete</button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods:{
    handleGetServicesByName(name) {
      ...
      this.$router.go(this.$router.push('/dashboard/services/compensations/search/' + name))
    },
    ...
    goToAddService() {
      this.$router.push('/dashboard/services/compensations/add')
    },
    ...
    handleDeleteService(id) {
      ...
      this.$store.commit('setServices', tab)
      this.$router.go()
    },
    handleGetServicesByType(id) {
    ...
    goToUpdateService(id) { 
      ...
      this.$router.push('/dashboard/services/compensations/update')
    },
  }
}
</script>
