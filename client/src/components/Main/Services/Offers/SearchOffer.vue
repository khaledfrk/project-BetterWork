              ...
              <div class="row  shadow m-1 mb-4" v-for="serv in services" :key="serv._id">
                ...
                <div class="col-3">
                  <div class="row justify-content-end">
                    <button @click="goToOfferDetails(serv._id)" class="btn btn-primary btn btn-outline mt-4 pt-2 pb-2 pr-5 pl-5 btn-grad col-4" style="font-size: small;">Request</button>
                  </div>
                </div>
              </div>
            </div>
