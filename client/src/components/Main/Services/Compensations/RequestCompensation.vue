        ...
        <div class="jumbotron m-2">
            ...
            <div class="form-group">
                ...
                <div class="row mt-4" v-for="doc in service.documents" :key="doc">
                    ...
                    <div class="input-group col-3" :class="{ invalid: $v.file.$error }">
                        ...
                        <input :id="removeSpace(doc)+'-default-btn'" type="file" hidden @blur="$v.file.$touch()">
                    </div>
                </div>
    ...
    export default {
      ...
      file: {
        ...
        methods: {
            ...
            goBack() {
                this.$router.push('/compensations')
            },
